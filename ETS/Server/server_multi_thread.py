...
alldata['5'] = dict(nomor=5, nama="mas striker", posisi="striker")
alldata['6'] = dict(nomor=6, nama="mas midfield", posisi="midfielder")
alldata['7'] = dict(nomor=7, nama="mas foward", posisi="foward")
alldata['8'] = dict(nomor=8, nama="mas cadangan 1", posisi="striker")
alldata['9'] = dict(nomor=9, nama="mas cadangan 2", posisi="foward")
alldata['10'] = dict(nomor=10, nama="mas cadangan 3", posisi="kiper")
